...
function BannersSmart() {
  ...
  const columns: Column[] = [
    { Header: 'Categoría', accessor: 'item' as keyof RowData },
    { Header: 'Fecha Creación', accessor: 'price' as keyof RowData },
    {
      Header: 'Estado',
              ...
              <div className="w-[50%]">
                <div className="p-6">
                  ...
                  <div className="flex flex-col mb-5.5 gap-4">
                    <div>
                      <label
                        ...
                        htmlFor="emailAddress"
                      >
                        Seleccione tipo de banner * (Inicio / Destacados /
                        Noticias)
                      </label>
                      <input className="w-full rounded border border-stroke py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary" />
                    </div>
                  ...
                  <div className="w-full flex gap-4 justify-between">
                    <div className="w-1/2 flex flex-col mb-5.5 gap-4">
                      <div>
                        <label
                          className="mb-3 block text-sm font-medium text-black dark:text-white"
                          htmlFor="emailAddress"
