...
const Employees = () => {
  ...
  const columns: Column[] = [
    { Header: 'Usuarios', accessor: 'item' as keyof RowData },
    { Header: 'Rol', accessor: 'price' as keyof RowData },
    { Header: 'Fecha de Inicio', accessor: 'date' as keyof RowData },
    ...
    <>
      ...
      {showForm && (
        <div className="p-6 rounded-sm">
          <div className="text-2xl py-4 dark:border-strokedark">
