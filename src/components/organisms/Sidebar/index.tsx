        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                      ...
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/' ||
                            ...
                            pathname.includes('dashboard-super-admin')) && // Agregando condición para "dashboard-super-admin"
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === 'usuarios-smart' ||
                  pathname.includes('billetera-usuario')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              {/* <!-- Menu Gestión Empresarial --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === 'informacion-empresa' ||
                  pathname.includes('billetera-usuario')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('informacion-empresa') ||
                          pathname.includes('billetera-usuario')
                            ? 'bg-graydark dark:bg-meta-4'
                            : ''
                        }`}
                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('gestion-zona')
                            ? 'bg-graydark dark:bg-meta-4'
                            : ''
                        }`}
                        onClick={(e) => {
                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('smartBanners') ||
                          pathname.includes('notificaciones-smart')
                            ? 'bg-graydark dark:bg-meta-4'
                            : ''
                        }`}
                        onClick={(e) => {
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === 'cataegorias' || pathname.includes('categorias')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          ...
                          pathname.includes('cupones') ||
                          pathname.includes('mis-encuestas') ||
                          pathname.includes('oferta-flash') ||
                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('enviar-puntos') ||
                          pathname.includes('canjear-puntos') ||
                          pathname.includes('mis-encuestas') ||
                          pathname.includes('canjear-cupon') ||
                          pathname.includes('mis-movimientos')
                            ? 'bg-graydark dark:bg-meta-4'
                            : ''
                        }`}
                        onClick={(e) => {
                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('notificaciones-push') ||
                          pathname.includes('usuario-cerca') ||
                          pathname.includes('mis-encuestas') ||
                          pathname.includes('red-comercios')
                            ? 'bg-graydark dark:bg-meta-4'
                            : ''
                        }`}
                        onClick={(e) => {
              ...
              <li>
                <NavLink
                  to="/premium"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('premium') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
